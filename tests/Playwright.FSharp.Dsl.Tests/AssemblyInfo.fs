...
[<assembly: AssemblyTitleAttribute("Playwright.FSharp.Dsl.Tests")>]
[<assembly: AssemblyProductAttribute("Playwright.FSharp.Dsl")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Playwright.FSharp.Dsl.Tests"
    let [<Literal>] AssemblyProduct = "Playwright.FSharp.Dsl"
